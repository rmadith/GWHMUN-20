	...
	*/
	public function show() {
		...
		$header_image_options = array(
			'default' => esc_html__( 'Default', 'rock-band' ),
			'enable'  => esc_html__( 'Enable', 'rock-band' ),
			'disable' => esc_html__( 'Disable', 'rock-band' ),
		);
		...
		<p class="post-attributes-label-wrapper"><label class="post-attributes-label" for="my-music-band-header-image"><?php esc_html_e( 'Header Featured Image Options', 'rock-band' ); ?></label></p>
...
$my_music_band_metabox = new My_Music_Band_Metabox(
	...
	esc_html__( 'Rock Band  Options', 'rock-band' ), //metabox title
