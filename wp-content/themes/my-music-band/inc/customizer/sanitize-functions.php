<?php
/**
 * My Music Band Theme Options Sanitization Functions
 *
 ...
 */
function my_music_band_sanitize_select( $input, $setting ) {
 ...
 */
function my_music_band_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function my_music_band_sanitize_post( $input ) {
 ...
 */
function my_music_band_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function my_music_band_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function my_music_band_sanitize_number_range( $number, $setting ) {
