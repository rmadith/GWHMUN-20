...
class Admin {
	 ...
	 * @var array
	 */
	static private $settings_schema = null;
	 ...
	 * @var string
	 */
	static private $option_key = 'ti_white_label_inputs';
	...
	public function enqueue() {
		...
		wp_register_script( 'neve-white-label', NEVE_PRO_URL . 'includes/modules/white_label/build/build.js', $dependencies, NEVE_PRO_VERSION, true );
		wp_localize_script( 'neve-white-label', 'neveWhiteLabel', $this->get_localization() );
		wp_enqueue_script( 'neve-white-label' );

		wp_register_style( 'neve-white-label', NEVE_PRO_URL . 'includes/modules/white_label/build/build.css', [ 'wp-components' ], NEVE_PRO_VERSION );
