...
class My_Account extends Abstract_Component {
	...
	public function add_style( array $css_array = array() ) {
		...
		$css_array[] = [
			'selectors' => $this->default_selector . ':hover',
			'rules'     => [
				'background-color' => $id . '.backgroundHover',
			],
		];
		$css_array[] = [
			'selectors' => '.builder-item--' . $this->get_id() . ' .my-account-component .sub-menu > li > a,' . $this->default_selector . ',' . $this->default_selector . ' .my-account-label',
			'rules'     => [
				'color' => $id . '.text',
			],
		];
		$css_array[] = [
			'selectors' => $this->default_selector . ' .my-account-icon svg',
			'rules'     => [
				'fill' => $id . '.text',
			],
		];
		$css_array[] = [
			'selectors' => '.builder-item--' . $this->get_id() . ' .my-account-component .sub-menu > li:hover > a,' . $this->default_selector . ':hover .my-account-label',
			'rules'     => [
				'color' => $id . '.textHover',
			],
		];
		$css_array[] = [
			'selectors' => $this->default_selector . ':hover .my-account-icon svg',
			'rules'     => [
				'fill' => $id . '.textHover',
			],
		];
